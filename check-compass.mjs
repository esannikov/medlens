...
let revealChecks=0,bearingChecks=0;
...
console.log(JSON.stringify({status:'PASS',revealChecks,bearingChecks,scope:'active-branch opacity, all 27 punctate hover reveals, projected cluster bearings, scope, unchanged data'}));
