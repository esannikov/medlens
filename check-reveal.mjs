...
const before=lensGeometry(original,viz.id,all,position,1440,934);
const legacy=placeLabels(original,viz.id,all,before.points,before.paths,1440,934,measure);
